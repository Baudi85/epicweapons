...
execute @s[tag=!up] ~ ~ ~ execute @s ^ ^1.4 ^1.5 function opw/shooter/r_spear_t/spawn
execute @s[tag=up,tag=!high] ~ ~ ~ execute @s ^ ^1 ^4.5 function opw/hitbox/target
execute @s[tag=up,tag=!high] ~ ~ ~ execute @s ^ ^1 ^2 function opw/shooter/r_spear_t/spawn
execute @s[tag=up,tag=high] ~ ~ ~ execute @s ^ ^0.5 ^5 function opw/hitbox/target
execute @s[tag=up,tag=high] ~ ~ ~ execute @s ^ ^0.5 ^2.5 function opw/shooter/r_spear_t/spawn
